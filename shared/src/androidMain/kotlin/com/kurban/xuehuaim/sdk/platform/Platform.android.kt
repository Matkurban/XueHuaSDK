...
actual fun currentPlatform(): IMPlatform = IMPlatform.ANDROID

actual fun defaultDbPath(dbName: String): String =
    SdkAndroidContext.applicationContext.getDatabasePath(dbName).absolutePath
